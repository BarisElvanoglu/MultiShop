...
using MultiShop.Order.Application.Features.CQRS.Handler.AddressHandler;
...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class AddressesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateAddress([FromBody] CreateAddressCommand command)
        {
            ...
            return Ok("Adres bilgisi başarı ile eklendi");
        }
        ...
        public async Task<IActionResult> UpdateAddress([FromBody] UpdateAddressCommand command)
        {
            ...
            return Ok("Adres bilgisi başarı ile güncellendi");
        }   
        [HttpDelete("{id}")]
